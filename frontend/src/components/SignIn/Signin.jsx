...
const Signin = () => {
  ...
  const postData = async (e) => {
    ...
    if(domain!='dronacharya.info')
    {
      return alert("Only dronacharya's email ID's allowed.");
    }
    ...
    if (data.status === 422 || !data) {
      ...
      window.alert("Only Dronacharya's email ID's allowed");
    } 
      ...
      >
        <div class="form-container sign-up-container">
          <form action="#">
            ...
            <span id="Span">Use your @dronacharya.info email for registration</span>
            <input
              type="text"
              name="name"
              value={user.name}
        ...
        <div class="form-container sign-in-container">
          <form method="POST" action="#">
            ...
            <span id="Span" className="pb-5">
              Use your @dronacharya.info account
            </span>
            <input
              type="email"
              value={email_id}
